...
სანამ უშუალოდ პროექტის აღწერაზე გადავალ, დავიწყოთ ლოგერის აღწერით. ლოგერი წარმოადგენს რაღაც სტატიკური ობიექტის მსგავს სტრუქტურას და ქვია კონსოლი (ჯავასკრიპტთან მუშაობის ხანგრძლივი გამოცდილების გამო :დ). კონსოლს აქვს ორი სპეციფიური მეთოდი (set/unset)_file, რომლის საშუალებითაც შეგვიძლია დავუსეტოთ ფაილი კონსოლს რომელშიც გადაამისამართებს ლოგებს.
...
პროექტის დასაბილდად უბრალოდ ვუშვებთ make ბრძანებას, ძველი დაბილდული პროგრამის გასაწმენდად კი make clean-ს.
...
და გაშვება პროექტის ფოლდერიდან ბრძანებით $ build/client config
სერვერის გასაშვებად საჭიროა თავისუფალი პორტი მოცემულ ip-ზე და ფოლდერი რომელშიც მოახდენს ფაილების შენახვას სერვერი.

გასაშვებად პროექტის ფოლდერიდან $ build/server <ip> <port> <storage-folder>